...
%PSRUN% "& '%PYTHON%' -m PyInstaller --noconfirm --clean --windowed --onedir --name StillImageVideoRenderer --collect-data tkinterdnd2 --add-data 'presets_default.json;.' subtitle_image_mp4_maker.py"
if errorlevel 1 exit /b 1
